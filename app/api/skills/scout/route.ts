...
const SKILL_PATH = path.join(os.homedir(), '.claude', 'commands', 'job-scout.md')
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    return new Response(JSON.stringify({ error: 'job-scout skill not found at ' + SKILL_PATH }), { status: 500 })
  }
